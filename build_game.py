...
boss_urls = {}
for key, fname in [('odair_sprite', 'odair_sprite_clean.png'), ('odair_face', 'Rosto telinha.png'), ('xepa_boss', 'xepa_boss_final.png'), ('xepa_enemy', 'xepa_enemy_final.png'), ('pito_fara', 'pito fara\u00f3.png')]:
